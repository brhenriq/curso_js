...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (new GeraSenha());
...
var Geradores = /*#__PURE__*/function () {
  function Geradores() {
    _classCallCheck(this, Geradores);
  }

  _createClass(Geradores, [{
    key: "geraNumero",
    value: function geraNumero() {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (new Geradores());
...
(function () {
  document.addEventListener('click', function (e) {
    var el = e.target;
    var maiusculas = document.querySelector('.chk-maiusculas').checked;
    var minusculas = document.querySelector('.chk-minusculas').checked;
    var numeros = document.querySelector('.chk-numeros').checked;
    var simbolos = document.querySelector('.chk-simbolos').checked;
    var charQtd = document.querySelector('.qtd-caracteres').value;
    ...
    if (!numeros && !maiusculas && !minusculas && !simbolos) {
      ...
      senhaGerada.innerHTML = _modules_GeraSenha__WEBPACK_IMPORTED_MODULE_0__.default.geraNovaSenha(charQtd, numeros, maiusculas, minusculas, simbolos);
    }
  });
})();
})();
